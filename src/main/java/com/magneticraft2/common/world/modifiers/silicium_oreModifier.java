 ...
 * v1.0.0
 */
public record silicium_oreModifier(HolderSet<Biome> biome, Holder<PlacedFeature> feature) implements BiomeModifier {
    @Override
    ...
    public Codec<? extends BiomeModifier> codec() {
        return com.magneticraft2.common.registry.registers.BiomeModifier.silicium_ore.get();
    }
}
