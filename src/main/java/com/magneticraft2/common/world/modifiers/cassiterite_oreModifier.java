 ...
 * v1.0.0
 */
public record cassiterite_oreModifier(HolderSet<Biome> biome, Holder<PlacedFeature> feature) implements BiomeModifier {
    @Override
    ...
    public Codec<? extends BiomeModifier> codec() {
        return com.magneticraft2.common.registry.registers.BiomeModifier.cassiterite_ore.get();
    }
}
